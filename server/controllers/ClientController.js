...
exports.createClient = async (req, res) => {
    try {
        const {
            ...
            has20L, has50L, has70L, has100L, has150L, recurrenceDays, isAbrasel
        } = req.body;
...
exports.updateClient = async (req, res) => {
    try {
        ...
        const { name, tradeName, document, phone, additionalPhones, address, street, number, district, city, state, zip, reference, pricePerLiter, averageOilLiters, latitude, longitude, observations, has20L, has50L, has70L, has100L, has150L, recurrenceDays, isAbrasel } = req.body;
        ...
        await client.update({ name, tradeName, document: cleanDocument, phone, address: fullAddress, pricePerLiter, averageOilLiters, observations, has20L, has50L, has70L, has100L, has150L, recurrenceDays, isAbrasel });
